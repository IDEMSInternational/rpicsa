...
rain_seasonal <- seasonal_rain(data = daily_niger_1, station = "station_name", date_time = "date",
                               year = "year", doy = "doy", rain = "rain", end_type = "rain") %>% dplyr::pull(total_rain)
...
start_output_1 <- seasonal_rain(summary_data = summary_data, date_time = "date", station = "station_name", data = daily_niger_2, year = "year", start_date = "start_rain", end_date = "end_rain", rain = "rain")
start_output_2 <- seasonal_rain(summary_data = summary_data, date_time = "date", station = "station_name", data = daily_niger_2, year = "year", rain = "rain")
