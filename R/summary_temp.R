#' Mean Temperature (Month or annually)
#' @description: Returns a summary data frame giving either the mean minimum and/or maximum temperature each year from 1 Jan to 31 Dec, or by year and month.
#' 
